...
my $path_to_file       			= getProperty($ec, "path_to_file", 1);
...
my $url = 'https://' . $puppet_master_url . '/puppet/v3/file_metadata/' . $path_to_file .
